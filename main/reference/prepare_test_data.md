...
TESTDAT, TESTTIM, TESTYN, ORRES) for subsequent missing test checks.
...
- test_time_var:
  ...
  Character string, original test time variable (default: NULL). If NULL
  or empty, TESTTIM column will be NA
...
- TESTTIM:
  ...
  Test time (derived, mapped from test_time_var)
...
5.  Return dataset with original test columns and derived columns in
    ...
    TESTDAT, TESTTIM, ORRES, other original columns
